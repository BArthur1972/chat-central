                ...
                <Form>
                    <Modal.Body>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="username" className="form-control" id="exampleFormControlInput1" placeholder="Enter Your New Username" onChange={(e) => { setName(e.target.value) }} value={name} />
                        </Form.Group>
                    </Modal.Body>
                    <Modal.Footer>
